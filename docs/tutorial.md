...
- If all else fails, `clawspark uninstall && curl -fsSL https://clawspark.hitechclaw.com/install.sh | bash` gives you a clean start without losing conversation history.
